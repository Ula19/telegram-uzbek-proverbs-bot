...
Использование:
- В кнопках: icon_custom_emoji_id=E_ID["book"]
- В тексте (HTML): E["book"] → <tg-emoji emoji-id="...">📖</tg-emoji>
"""
...
E_ID = {
    ...
    "heart": "5258185631355378853",    # ⭐ (используем star как сердце для избранного)
